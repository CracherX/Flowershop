...
SECRET_KEY = 'django-insecure-oofz_si+08gah1ql_9&0i8czh$y*68mtbuadt-5#_4fv^swq(1'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'flowershopk',  # Имя вашей базы данных MySQL
        'USER': 'root',  # Ваше имя пользователя MySQL
        'PASSWORD': '',  # Ваш пароль MySQL
        'HOST': 'localhost',  # Адрес хоста MySQL (обычно 'localhost' для локального сервера)
